...
prefixes, which is what makes path-based erasure provable — §4.1):
    ...
    └── .strata/                            # DERIVED — delete + `strata reindex` rebuilds
...
class Repo:
    def __init__(self, root: str | Path):
        ...
        self.strata_dir = self.root / ".strata"
    ...
    def scaffold(cls, root: str | Path) -> "Repo":
        ...
        for d in (repo.wiki_dir, repo.raw_dir / "failed", repo.strata_dir):
...
def format_index(entries: list[tuple]) -> str:
    ...
    lines = [
        "# Memory Index", "",
        "Auto-generated by Strata after every write — do not edit by hand.", "",
    ]
