...
Queued items are JSON files under .markmem/review/ — inspectable with any
editor, decided with `markmem review`. Every decision lands in the ops ledger,
...
class ReviewQueue:
    def __init__(self, markmem_dir: Path, ledgers: Ledgers):
        self.dir = markmem_dir / "review"
